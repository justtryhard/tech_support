...
- на страницах со списком тикетов и проблем можно закрыть необходимый тикет или проблему по ID. Допускается также закрыть уже закрытый тикет, в этом случае ничего не произойдёт.
